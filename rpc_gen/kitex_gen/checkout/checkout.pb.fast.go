...
func (x *CheckoutResp) fastReadField4(buf []byte, _type int8) (offset int, err error) {
...
func (x *CheckoutResp) fastWriteField4(buf []byte) (offset int) {
	if x.TransactionId == "" {
		return offset
	}
...
func (x *CheckoutResp) sizeField4() (n int) {
	if x.TransactionId == "" {
		return n
	}
