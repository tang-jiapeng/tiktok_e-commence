...
func (p ProductKafkaConsumer) Setup(_ sarama.ConsumerGroupSession) error {
	return nil
}

func (p ProductKafkaConsumer) Cleanup(_ sarama.ConsumerGroupSession) error {
	return nil
}

func (p ProductKafkaConsumer) ConsumeClaim(session sarama.ConsumerGroupSession, claim sarama.ConsumerGroupClaim) error {
